...
BOOST_AUTO_TEST_CASE(message_verify)
{
    ...
    const std::string key_address{EncodeDestination(PKHash(privkey.GetPubKey()))};
    const std::string script_address{EncodeDestination(ScriptHash(CScript{}))};
    std::string signature;
    BOOST_REQUIRE(MessageSign(privkey, "Trust no one", signature));
