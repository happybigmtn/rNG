...
std::string AddressDescriptor(const std::string& script_hex)
{
    std::vector<unsigned char> script_bytes{ParseHex(script_hex)};
    const CScript script{script_bytes.begin(), script_bytes.end()};
    CTxDestination destination;
    Assert(ExtractDestination(script, destination));
    return "addr(" + EncodeDestination(destination) + ")";
}
...
BOOST_AUTO_TEST_CASE(descriptor_test)
{
    ...
    CheckInferDescriptor("76a91445ff7c2327866472639d507334a9a00119dfd32688ac", AddressDescriptor("76a91445ff7c2327866472639d507334a9a00119dfd32688ac"), {}, {{"069228de6902abb4f541791f6d7f925b10e2078ccb1298856e5ea5cc5fd667f930eac37a00cc07f9a91ef3c2d17bf7a17db04552ff90ac312a5b8b4caca6c97aa4", ""}});
    // p2wpkh script with uncompressed key must infer as addr()
    CheckInferDescriptor("001422e363a523947a110d9a9eb114820de183aca313", AddressDescriptor("001422e363a523947a110d9a9eb114820de183aca313"), {}, {{"049228de6902abb4f541791f6d7f925b10e2078ccb1298856e5ea5cc5fd667f930eac37a00cc07f9a91ef3c2d17bf7a17db04552ff90ac312a5b8b4caca6c97aa4", ""}});
