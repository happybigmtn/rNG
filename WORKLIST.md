...
- [CHKPT-01] `specs/120426-operator-onboarding.md` and `specs/120426-release-distribution.md` describe repository-root `Dockerfile`, `docker-compose.yml`, and `scripts/install.sh`/`install.sh`; those files are still absent in the live checkout. Bootstrap assets are now tracked at height 29944.
